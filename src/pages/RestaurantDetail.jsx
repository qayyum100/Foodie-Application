...
//   const { id } = useParams();
//   const nav = useNavigate();
//   const rest = restaurantsData.find(r => r.id === id) || { id, name: id };
...
//   try {
//     await api.post(`/api/reviews/add?restaurantId=${id}&rating=${userRating}&comment=${comment}`);
...
//     try {
//       await api.post(`/api/rating/add?restaurantId=${id}&rating=${userRating}`);
//       alert("Rating submitted!");
...
//            <div className="star-rating-container">
//   {[1, 2, 3, 4, 5].map((num) => {
//     const isActive = num <= (hoverRating || userRating);
...
//   <button className="btn" onClick={submitReview} disabled={!comment || !userRating}>
//     Submit Review
//   </button>
// </div>
